...
if (isset($_POST['btnSave']))
{
	$email=$_POST['txtemail'];
		...
		$select="SELECT * FROM admintable1 Where Email='$email'";
		...
		if ($count>0) 
		{
			...
			try {
			    ...
			    $mail->send();
			    echo "<script>alert('Your Password has been sent on your Email ');window.location.assign('Login.php');</script>";
			} catch (Exception $e) {
...
<form action="Forget_Password.php" method="post" class="login100-form validate-form flex-sb flex-w">
