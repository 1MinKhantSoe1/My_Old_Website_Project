...
<header>
  <div class="container">
    <div class="row clearfix" id="home">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="contact">
          <p>Questions? Call us!<span class="number"><a href="#">000000000</a></span><span class="time">(11AM to 11PM)</span></p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="menu">
          ...
          <nav>
            <ul>
              ...
              <li><a href="DisplayAdminRegister.php">View all admin account</a></li>
            </ul>
          </nav>
        </div>
        <div class="login">
          <ul>
            <li><a href="OrderList.php">View Order List</a></li>
            <li><a href="OrderSearch.php">Search Order And Purchase</a></li>
            <!-- <li><a href="DisplayRestaurant.php">View Restaurant List</a></li> -->
          </ul>
        </div>
      </div>
    </div>
